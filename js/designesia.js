...
(function($) {
    ...
    let lastScrollPosition;
     ...
     function initResize() {
       ...
       // Screen ≤ 1199px (menu horizontal não cabe entre 993 e 1199 → hambúrguer)
  ...
  new WOW().init();
    ...
    $('.dot-hover').on('mouseleave', function () {
     ...
     $(function(){
        ...
        // trava de segurança: esconde o loader após no máx. 4s, mesmo que algum recurso demore/falhe
        setTimeout(function(){ jQuery('#de-loader').fadeOut(300); }, 4000);
         'use strict';
         modeRtl();         
         $(".jarallax").jarallax();
         loadMagnificPopup();
